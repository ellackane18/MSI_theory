...
class Extract_Rate_Constants:
    ...
    def run(self, calculation_directory, p_list, states_dict, TP_shape, TP_dict):
        ...
        reaction_label, fit = self.pull_out_chebyshev_fit(lines,p_list,TP_shape)
        ...
        self.write_out_reactions(dict_of_reactions_unites_converted, T_min=200, T_max=4000, P_min=0.0001, P_max=100)