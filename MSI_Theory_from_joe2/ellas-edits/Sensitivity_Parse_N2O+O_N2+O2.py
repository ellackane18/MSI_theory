...
lines=load_text_file('/home/eck/MSI_Theory_from_joe2/PAPR-MESS_calculation/N2+O2/calculation_16/'+file_name)
...
build_reaction_string(p_list, temp_dict = {'P1':'N2O + O', 'P2':'N2 + O2'})
